...
do
    command_sql="python3 generate_vo_files.py ${file_prefix} ${query} ego-twitter sql ${ring} ${redirect}"
    command_txt="python3 generate_vo_files.py ${file_prefix} ${query} ego-twitter vo ${ring} ${redirect}"
    command_app="python3 generate_vo_files.py ${file_prefix} ${query} ego-twitter app ${ring} ${redirect}"
