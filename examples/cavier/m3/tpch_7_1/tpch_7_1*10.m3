...
AggSum([],
 ((V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local> * V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local>) * [lift<8>: RingFactorizedRelation<[8, int,int]>](SUPPKEY,PARTKEY))
);

DECLARE MAP V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY: int,PARTKEY: int] :=
AggSum([SUPPKEY, PARTKEY],
 ((partsupp(PARTKEY,SUPPKEY,PS_AVAILQTY,PS_SUPPLYCOST,PS_COMMENT)) * [lift<10>: RingFactorizedRelation<[10, int]>](PS_AVAILQTY))
);

DECLARE MAP V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY: int,PARTKEY: int] :=
AggSum([SUPPKEY, PARTKEY],
 ((Q4(N_NAME,R_NAME,NATIONKEY,REGIONKEY,C_NAME,ORDERKEY,CUSTKEY,O_ORDERSTATUS,PARTKEY,L_LINENUMBER,SUPPKEY)) * [lift<11>: RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,O_ORDERSTATUS,L_LINENUMBER,N_NAME,R_NAME))
);
-- Q6

DECLARE MAP V_Q5part(RingFactorizedRelation<[20, int]>)[][] :=
AggSum([],
 ((V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local> * V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local>) * [lift<20>: RingFactorizedRelation<[20, int]>](PARTKEY))
);

DECLARE MAP V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY: int] :=
AggSum([PARTKEY],
 ((Q5(N_NAME,R_NAME,NATIONKEY,REGIONKEY,C_NAME,ORDERKEY,CUSTKEY,O_ORDERSTATUS,PARTKEY,L_LINENUMBER,SUPPKEY,PS_AVAILQTY)) * [lift<21>: RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,PS_AVAILQTY,O_ORDERSTATUS,SUPPKEY,L_LINENUMBER,N_NAME,R_NAME))
);

DECLARE MAP V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY: int] :=
AggSum([PARTKEY],
 ((part(PARTKEY,P_NAME,P_MFGR,P_BRAND,P_TYPE,P_SIZE,P_CONTAINER,P_RETAILPRICE,P_COMMENT)) * [lift<32>: RingFactorizedRelation<[32, string]>](P_NAME))
);
-- Q4
...
-- Q5
DECLARE MAP TMP_partsupp_V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY: int,PARTKEY: int] :=
AggSum([SUPPKEY, PARTKEY],
 (((DELTA partsupp)(PARTKEY,SUPPKEY,PS_AVAILQTY,PS_SUPPLYCOST,PS_COMMENT)) * [lift<10>: RingFactorizedRelation<[10, int]>](PS_AVAILQTY))
);
DECLARE MAP TMP_partsupp_V_Q4partsupp(RingFactorizedRelation<[8, int,int]>)[][] :=
AggSum([],
 ((TMP_partsupp_V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local> * V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local>) * [lift<8>: RingFactorizedRelation<[8, int,int]>](SUPPKEY,PARTKEY))
);
DECLARE MAP TMP_Q4_V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY: int,PARTKEY: int] :=
AggSum([SUPPKEY, PARTKEY],
 (((DELTA Q4)(N_NAME,R_NAME,NATIONKEY,REGIONKEY,C_NAME,ORDERKEY,CUSTKEY,O_ORDERSTATUS,PARTKEY,L_LINENUMBER,SUPPKEY)) * [lift<11>: RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,O_ORDERSTATUS,L_LINENUMBER,N_NAME,R_NAME))
);
DECLARE MAP TMP_Q4_V_Q4partsupp(RingFactorizedRelation<[8, int,int]>)[][] :=
AggSum([],
 ((TMP_Q4_V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local> * V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local>) * [lift<8>: RingFactorizedRelation<[8, int,int]>](SUPPKEY,PARTKEY))
);
-- Q6
DECLARE MAP TMP_Q5_V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY: int] :=
AggSum([PARTKEY],
 (((DELTA Q5)(N_NAME,R_NAME,NATIONKEY,REGIONKEY,C_NAME,ORDERKEY,CUSTKEY,O_ORDERSTATUS,PARTKEY,L_LINENUMBER,SUPPKEY,PS_AVAILQTY)) * [lift<21>: RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,PS_AVAILQTY,O_ORDERSTATUS,SUPPKEY,L_LINENUMBER,N_NAME,R_NAME))
);
DECLARE MAP TMP_Q5_V_Q5part(RingFactorizedRelation<[20, int]>)[][] :=
AggSum([],
 ((TMP_Q5_V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local> * V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local>) * [lift<20>: RingFactorizedRelation<[20, int]>](PARTKEY))
);
DECLARE MAP TMP_part_V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY: int] :=
AggSum([PARTKEY],
 (((DELTA part)(PARTKEY,P_NAME,P_MFGR,P_BRAND,P_TYPE,P_SIZE,P_CONTAINER,P_RETAILPRICE,P_COMMENT)) * [lift<32>: RingFactorizedRelation<[32, string]>](P_NAME))
);
DECLARE MAP TMP_part_V_Q5part(RingFactorizedRelation<[20, int]>)[][] :=
AggSum([],
 ((TMP_part_V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local> * V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local>) * [lift<20>: RingFactorizedRelation<[20, int]>](PARTKEY))
);
-- Q4
...
DECLARE QUERY V_partsupp := V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local>;
DECLARE QUERY V_Q4 := V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local>;
-- Q6
DECLARE QUERY V_Q5part := V_Q5part(RingFactorizedRelation<[20, int]>)[][]<Local>;
DECLARE QUERY V_Q5 := V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local>;
DECLARE QUERY V_part := V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local>;
-- Q4
...
ON BATCH UPDATE OF partsupp { 
 TMP_partsupp_V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local> := AggSum([SUPPKEY, PARTKEY], ((DELTA partsupp)(PARTKEY, SUPPKEY, PS_AVAILQTY, PS_SUPPLYCOST, PS_COMMENT) * [lift<10>: RingFactorizedRelation<[10, int]>](PS_AVAILQTY)));
V_Q4partsupp(RingFactorizedRelation<[8, int,int]>)[][]<Local>  +=  AggSum([], (TMP_partsupp_V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY] * V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local>) * [lift<8>: RingFactorizedRelation<[8, int,int]>](SUPPKEY,PARTKEY));
V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local> += TMP_partsupp_V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY];
}
ON BATCH UPDATE OF Q4 { 
 TMP_Q4_V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local> := AggSum([SUPPKEY, PARTKEY], ((DELTA Q4)(N_NAME, R_NAME, NATIONKEY, REGIONKEY, C_NAME, ORDERKEY, CUSTKEY, O_ORDERSTATUS, PARTKEY, L_LINENUMBER, SUPPKEY) * [lift<11>: RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,O_ORDERSTATUS,L_LINENUMBER,N_NAME,R_NAME)));
V_Q4partsupp(RingFactorizedRelation<[8, int,int]>)[][]<Local>  +=  AggSum([], (TMP_Q4_V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY] * V_partsupp(RingFactorizedRelation<[10, int]>)[][SUPPKEY,PARTKEY]<Local>) * [lift<8>: RingFactorizedRelation<[8, int,int]>](SUPPKEY,PARTKEY));
V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY]<Local> += TMP_Q4_V_Q4(RingFactorizedRelation<[11, int,int,string,int,int,string,int,string,string]>)[][SUPPKEY,PARTKEY];
}
-- Q6
ON BATCH UPDATE OF Q5 { 
 TMP_Q5_V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local> := AggSum([PARTKEY], ((DELTA Q5)(N_NAME, R_NAME, NATIONKEY, REGIONKEY, C_NAME, ORDERKEY, CUSTKEY, O_ORDERSTATUS, PARTKEY, L_LINENUMBER, SUPPKEY, PS_AVAILQTY) * [lift<21>: RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>](REGIONKEY,NATIONKEY,C_NAME,CUSTKEY,ORDERKEY,PS_AVAILQTY,O_ORDERSTATUS,SUPPKEY,L_LINENUMBER,N_NAME,R_NAME)));
V_Q5part(RingFactorizedRelation<[20, int]>)[][]<Local>  +=  AggSum([], (TMP_Q5_V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY] * V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local>) * [lift<20>: RingFactorizedRelation<[20, int]>](PARTKEY));
V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local> += TMP_Q5_V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY];
}
ON BATCH UPDATE OF part { 
 TMP_part_V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local> := AggSum([PARTKEY], ((DELTA part)(PARTKEY, P_NAME, P_MFGR, P_BRAND, P_TYPE, P_SIZE, P_CONTAINER, P_RETAILPRICE, P_COMMENT) * [lift<32>: RingFactorizedRelation<[32, string]>](P_NAME)));
V_Q5part(RingFactorizedRelation<[20, int]>)[][]<Local>  +=  AggSum([], (TMP_part_V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY] * V_Q5(RingFactorizedRelation<[21, int,int,string,int,int,int,string,int,int,string,string]>)[][PARTKEY]<Local>) * [lift<20>: RingFactorizedRelation<[20, int]>](PARTKEY));
V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY]<Local> += TMP_part_V_part(RingFactorizedRelation<[32, string]>)[][PARTKEY];
}
-- Q4
