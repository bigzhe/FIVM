...
do
    ...
    rm -f ./outputs/retailer_static_list_$i.txt 
    touch ./outputs/retailer_static_list_$i.txt
    ...
    do
        ...
        # run retailer
        ./bin/retailer/retailer_static_list_BATCH_1000 --no-output >> ./outputs/retailer_static_list_$i.txt
    ...
    rm -f ./outputs/housing_static_list_$i.txt
    touch ./outputs/housing_static_list_$i.txt
    ...
    do
        ...
        # run housing
        ./bin/housing/housing_static_list_BATCH_1000 --no-output >> ./outputs/housing_static_list_$i.txt
    ...
    rm -f ./outputs/favorita_static_list_$i.txt
    touch ./outputs/favorita_static_list_$i.txt
    ...
    do
        ...
        # run favorita
        ./bin/favorita/favorita_static_list_BATCH_1000 --no-output >> ./outputs/favorita_static_list_$i.txt
