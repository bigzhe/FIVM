...
namespace dbtoaster {
  ...
  protected:
    ...
    RingFactorizedRelation<0, DOUBLE_TYPE> V_postcode_HSIRDT1 = RingFactorizedRelation<0, DOUBLE_TYPE>();
    ...
    void on_system_ready_event() {
      ...
      { //foreach
        ...
        while (e7) {
          ...
          long v7 = e7->__av;
          V_house_H1.addOrDelOnZero(se7.modify(postcode), (v7 * Ulift<1>(livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking)));
          e7 = e7->nxt;
        }
      }
      ...
      { //foreach
        V_SHOP_entry* e8 = V_SHOP.head;
        while (e8) {
          DOUBLE_TYPE postcode = e8->postcode;
          ...
          long v8 = e8->__av;
          V_sainsburys_S1.addOrDelOnZero(se8.modify(postcode), (v8 * Ulift<11>(openinghoursshop, pricerangeshop, sainsburys, tesco, ms)));
          e8 = e8->nxt;
        }
      }
      ...
      { //foreach
        V_INSTITUTION_entry* e9 = V_INSTITUTION.head;
        while (e9) {
          DOUBLE_TYPE postcode = e9->postcode;
          DOUBLE_TYPE typeeducation = e9->typeeducation;
          DOUBLE_TYPE sizeinstitution = e9->sizeinstitution;
          long v9 = e9->__av;
          V_typeeducation_I1.addOrDelOnZero(se9.modify(postcode), (v9 * Ulift<16>(typeeducation, sizeinstitution)));
          e9 = e9->nxt;
        }
      }
      ...
      { //foreach
        V_RESTAURANT_entry* e10 = V_RESTAURANT.head;
        while (e10) {
          DOUBLE_TYPE postcode = e10->postcode;
          DOUBLE_TYPE openinghoursrest = e10->openinghoursrest;
          DOUBLE_TYPE pricerangerest = e10->pricerangerest;
          long v10 = e10->__av;
          V_pricerangerest_R1.addOrDelOnZero(se10.modify(postcode), (v10 * Ulift<18>(openinghoursrest, pricerangerest)));
          e10 = e10->nxt;
        }
      }
      ...
      { //foreach
        V_DEMOGRAPHICS_entry* e11 = V_DEMOGRAPHICS.head;
        while (e11) {
          ...
          long v11 = e11->__av;
          V_unemployment_D1.addOrDelOnZero(se11.modify(postcode), (v11 * Ulift<20>(averagesalary, crimesperyear, unemployment, nbhospitals)));
          e11 = e11->nxt;
        }
      }
      ...
      { //foreach
        V_TRANSPORT_entry* e12 = V_TRANSPORT.head;
        while (e12) {
          DOUBLE_TYPE postcode = e12->postcode;
          ...
          long v12 = e12->__av;
          V_nbbuslines_T1.addOrDelOnZero(se12.modify(postcode), (v12 * Ulift<24>(nbbuslines, nbtrainstations, distancecitycentre)));
          e12 = e12->nxt;
        }
      }
      ...
      { //foreach
        V_house_H1_entry* e13 = V_house_H1.head;
        while (e13) {
          DOUBLE_TYPE postcode = e13->postcode;
          RingFactorizedRelation<1, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE, DOUBLE_TYPE>& v13 = e13->__av;
          V_postcode_HSIRDT1 += ((((((v13 * V_sainsburys_S1.getValueOrDefault(se14.modify(postcode))) * V_typeeducation_I1.getValueOrDefault(se15.modify(postcode))) * V_pricerangerest_R1.getValueOrDefault(se16.modify(postcode))) * V_unemployment_D1.getValueOrDefault(se17.modify(postcode))) * V_nbbuslines_T1.getValueOrDefault(se18.modify(postcode))) * Ulift<0>(postcode));
          e13 = e13->nxt;
        }
      }
    }
  ...
  private:
      ...
      V_sainsburys_S1_entry se14;
      V_typeeducation_I1_entry se15;
      V_pricerangerest_R1_entry se16;
      V_unemployment_D1_entry se17;
      V_nbbuslines_T1_entry se18;
