IMPORT DTREE FROM FILE 'tpch_7_0*1-Q3.txt';
...
SELECT SUM(
	...
	[lift<3>: RingFactorizedRelation<[3, CHAR(25),VARCHAR(152)]>](n_name,n_comment) *
	[lift<5>: RingFactorizedRelation<[5, VARCHAR(152),CHAR(25)]>](r_comment,r_name) 
)
