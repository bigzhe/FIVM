IMPORT DTREE FROM FILE 'tpch_8_0*10-Q7.txt';
...
SELECT SUM(
	...
	[lift<7>: RingFactorizedRelation<[7, CHAR(1)]>](o_orderstatus) *
	[lift<8>: RingFactorizedRelation<[8, VARCHAR(25)]>](c_name) 
)
FROM partsupp NATURAL JOIN lineitem NATURAL JOIN orders NATURAL JOIN customer NATURAL JOIN part NATURAL JOIN supplier;
