IMPORT DTREE FROM FILE 'tpch_8_0*10-Q5.txt';
...
SELECT SUM(
	...
	[lift<5>: RingFactorizedRelation<[5, CHAR(1)]>](o_orderstatus) *
	[lift<6>: RingFactorizedRelation<[6, VARCHAR(25)]>](c_name) 
)
FROM partsupp NATURAL JOIN lineitem NATURAL JOIN orders NATURAL JOIN customer;
