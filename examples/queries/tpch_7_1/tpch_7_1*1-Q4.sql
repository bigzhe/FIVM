IMPORT DTREE FROM FILE 'tpch_7_1*1-Q4.txt';
...
SELECT SUM(
	...
	[lift<10>: RingFactorizedRelation<[10, INT,DECIMAL,INT]>](partkey,l_quantity,suppkey) *
	...
	[lift<4>: RingFactorizedRelation<[4, VARCHAR(152),CHAR(25)]>](n_comment,n_name) *
